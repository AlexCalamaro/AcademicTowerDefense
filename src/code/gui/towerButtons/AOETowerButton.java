 ...
 * @version May 26, 2014
 */
public class AOETowerButton extends TowerButton
{

	public AOETowerButton(final UpgradeMenu menu) {
		super(menu, "AOETower.jpg", AOETower.DESCRIPTION);
	}
	/**
	...
	{
		return new AOETower(location);
	}
	
	protected int getCost()
	{
		return AOETower.DEFAULT_COST;
	}
