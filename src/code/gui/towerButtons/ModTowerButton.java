 ...
 * @version May 26, 2014
 */
public class ModTowerButton extends TowerButton
{
	public ModTowerButton(final UpgradeMenu menu) 
	{
		super(menu, "ModTower.jpg", ModTower.DESCRIPTION);
	}
	/**
	...
	{
		return new ModTower(location);
	}
	protected int getCost()
	{
		return ModTower.DEFAULT_COST;
	}
